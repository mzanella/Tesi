...
\section{Tecnologie utilizzate}
	...
	\subsection{Google AutoValue}
		Google AutoValue è una libreria che permette la generazione automatica del codice delle classi provviste di annotazioni proprie della libreria. Tale libreria permette di creare gli oggetti di tale classi utilizzando il design pattern Builder. È utilizzata per le classi che potrebbero richiedere molti parametri nel costruttore, evitando così il fenomeno del telescoping. 
		\subsubsection{Vantaggi}
			\begin{itemize}	
