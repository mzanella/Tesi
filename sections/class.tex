	...
	Di seguito vengono riportate le descrizioni delle classi più importanti dell'applicazione.
			...
			\begin{itemize}
				...
				\begin{description}
					...
					\begin{itemize}
						...
						Oggetto che contiene i dati con cui devono essere inizializzati i campi dati della nuova istanza di \mclass{Content}
					\end{itemize}
				\end{description}
		...
		\begin{description}
			...
			\begin{itemize}
				...
				Metodo che permette di ricavare una istanza di un oggetto \mclass{Builder} per la costruzione di un oggetto \mclass{StartResult}, inizializzando i campi dati sfruttando l'oggetto JsonObject passato. È un metodo statico
