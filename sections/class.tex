	...
	Di seguito vengono riportate le descrizioni delle classi più importanti dell'applicazione.
		...
		\begin{description}
			...
			\begin{itemize}
				...
				Metodo che si occupa di istanziare gli oggetti che controllano quando vi sono cambiamenti nello stato della connessione Internet del dispositivo e nel database degli statement all'avvio dell'applicazione. Inoltre ha il compito di registrare un oggetto di tipo \minterface{StatementSender} come listener per entrambi gli oggetti istanziati
